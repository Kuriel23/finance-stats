...
const sales = [
	...
	{ date: "2024-04-30", value: 8.1 },
	{ date: "2025-04-30", value: 48 },
];
	...
	return (
				...
				{yScale
					...
					.map((value, i) => (
						<div
							...
							className="absolute text-xs tabular-nums -translate-y-1/2 text-gray-500 dark:text-gray-300 w-full text-right pr-2"
						>
							{value}
						</div>
					))}
        ...
        "
			>
				...
				>
					<div className="animate-ping w-full h-full rounded-full bg-pink-500 border-2 border-pink-400" />
				</div>
				<svg
					viewBox="0 0 100 100"
					...
					{data.map((day, i) => {
						...
						return (
							<div
								// biome-ignore lint/suspicious/noArrayIndexKey: <explanation>
								key={i}
								className="overflow-visible text-zinc-500 dark:text-zinc-300"
							>
								<div
									style={{
